<div>
    <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-gray-800 mb-2">Mes Bureaux de Vote</h1>
                <p class="text-gray-600">Gérez et saisissez les résultats de vos bureaux assignés</p>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-lg p-5 hover:shadow-xl transition border-l-4 {{ $bureau->resultat ? 'border-green-500' : 'border-gray-300' }}">
                <div class="flex items-start justify-between mb-3">
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-gray-600">{{ $bureau->lieuVote->commune }}</p>
                    </div>
                    @if($bureau->resultat)
